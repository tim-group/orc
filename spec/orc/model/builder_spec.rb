...
describe Orc::Model::Builder do
  ...
  it 'supports a vanilla pass through' do
    ...
    expect(instance.missing?).to eq (false)
    expect(instance.being_cleaned?).to eq (false)
    expect(instance.being_provisioned?).to eq (false)
    ...
    expect(instance.missing?).to eq (true)
    expect(instance.being_cleaned?).to eq (false)
    expect(instance.being_provisioned?).to eq (true)
